    ...
    state:{
      ...
      complete: {
        ...
        error: {
          ...
          deleteButton: 'text-error-700 hover:text-error-900 dark:error-400 dark:hover:text-error-300'
      },     
    },
  },
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sm text-red-400 dark:text-error-500">
              {name}
            </span>
          </div>

          <button type="button" className="text-sm font-semibold text-red-400 hover:text-red-900 dark:text-error-400 dark:hover:text-error-300">
            Try again
          </button>
        </div>
      ):( 
...

    {
      state === 'complete' ? (
        ...
        <Button type="button" variant='ghost' className={deleteButton()}>
          <Trash2 className="h-5 w-5 text-zinc-500 dark:text-error-200 hover:text-error-400"  />
        </Button>
      )
    }
